...
| **REGISTRO LIBRE** | *Cualquier correo* | *Cualquier clave* | En la pantalla de inicio de sesión (`login.html`), la catedrática puede usar la pestaña **"Registrarse"** para crear al instante usuarios con rol `CLIENTE`, `OPERADOR` o `ADMIN`. |
