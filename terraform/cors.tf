...
resource "aws_api_gateway_gateway_response" "cors_4xx" {
  ...
  response_parameters = {
    ...
    "gatewayresponse.header.Access-Control-Allow-Headers" = "'Content-Type,Authorization,Idempotency-Key,idempotency-key'"
...
locals {
  ...
  cors_integration_response_parameters = {
    ...
    "method.response.header.Access-Control-Allow-Headers" = "'Content-Type,Authorization,Idempotency-Key,idempotency-key'"
